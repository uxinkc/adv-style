...
$('body').on('click', '[data-behavior~="toggle-rwd-size"]', function(event) {
  ...
  $self
    .removeClass('adv-bg:hover--tertiary-100')
    .addClass('adv-bg--secondary-100')
    .attr('aria-selected', true)
    .siblings()
    .removeClass('adv-bg--secondary-100')
    .removeAttr('aria-selected')
    .addClass('adv-bg:hover--tertiary-100')
  ;
...
$('body').on('change', '[data-behavior~="toggle-rwd-table"]', function(event) {
  ...
  $target.toggleClass('adv-table--responsive-horizontal');
